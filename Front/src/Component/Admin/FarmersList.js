    ...
    return (
        <div>
            ...
            <div className="container">
                <h3 className='mt-2'>List of Seller</h3>
                <hr />
                <div>

                    <button type="button" className="btn btn-primary mb-3" onClick={() => navigate('/admin/addnewfarmer')}>Add New Seller</button>
            ...
            <div className="text-center  text-muted" style={{marginTop: '100px', marginBottom: '35px'}}>
                Copyright &copy; 2024 &mdash; FarmersMarket
            </div>
        </div>
    );
}
